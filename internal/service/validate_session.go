...
func (s *service) ValidateSession(ctx context.Context, params *model.ValidateSessionInput) (*model.ValidateSessionResponse, error) {
	log := s.Log.With().Str("func", "ValidateSession").Logger()
