...
func (s *service) AddWebhook(ctx context.Context, params *model.AddWebhookRequest) (*model.Response, error) {
	log := s.Log.With().Str("func", "AddWebhook").Logger()
	...
	_, err = s.StorageProvider.AddWebhook(ctx, &schemas.Webhook{
