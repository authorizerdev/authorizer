...
const AuditLogs = () => {
  ...
  const fetchLogs = useCallback(
    ...
    [client, actionFilter, actorTypeFilter, resourceTypeFilter, fromDate, toDate],
  );
  ...
  const getActionBadgeVariant = (
    ...
    if (action.includes('success') || action.includes('signup') || action.includes('created'))
      return 'success';
    if (action.includes('failed') || action.includes('revoked') || action.includes('deleted'))
      return 'destructive';
                    ...
                    <React.Fragment key={log.id}>
                      ...
                      >
                        ...
                        <TableCell className="whitespace-nowrap text-sm text-gray-600">
                          {dayjs.unix(log.created_at).format('MMM D, YYYY HH:mm:ss')}
                        </TableCell>
                        <TableCell>
