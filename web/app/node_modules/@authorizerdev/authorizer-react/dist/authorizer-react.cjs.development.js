...
var isEmail = _interopDefault(require('validator/es/lib/isEmail'));
var isMobilePhone = _interopDefault(require('validator/es/lib/isMobilePhone'));
...
var AuthorizerContext = /*#__PURE__*/React.createContext({
  config: {
    authorizerURL: '',
    redirectURL: '/',
    client_id: '',
  ...
  authorizerRef: /*#__PURE__*/new authorizerJs.Authorizer({
...
var AuthorizerProvider = function AuthorizerProvider(_ref) {
  ...
  var authorizerRef = React.useRef(new authorizerJs.Authorizer({
  ...
  return React__default.createElement(AuthorizerContext.Provider, {
...
var useAuthorizer = function useAuthorizer() {
  return React.useContext(AuthorizerContext);
};
...
var Message = function Message(_ref) {
  ...
  if (text.trim()) {
    return React__default.createElement(StyledMessageWrapper, {
      type: type,
      styles: extraStyles
    }, React__default.createElement(StyledFlex, {
      alignItems: "center",
    ...
    }, capitalizeFirstLetter(text)), onClose && React__default.createElement("span", {
      style: {
        cursor: 'pointer'
      },
      onClick: onClose
...
var PasswordStrengthIndicator = function PasswordStrengthIndicator(_ref) {
  ...
  var _React$useState = React__default.useState(_extends({}, validatePassword(value || ''))),
  ...
  return React__default.createElement("div", null, React__default.createElement(StyledPasswordStrengthWrapper, null, React__default.createElement(StyledFlex, {
    alignItems: "center",
    justifyContent: "center",
    wrap: "nowrap"
  }, React__default.createElement(StyledPasswordStrength, {
  ...
  }), !!score && React__default.createElement("div", null, strength))), React__default.createElement("p", null, React__default.createElement("b", null, "Criteria for a strong password:")), React__default.createElement(StyledFlex, {
  ...
  }, "At least 6 characters")), React__default.createElement(StyledFlex, {
    justifyContent: "flex-start",
    alignItems: "center",
    width: "100%"
  }, React__default.createElement("input", {
  ...
  }, "At least 1 lowercase letter")), React__default.createElement(StyledFlex, {
    justifyContent: "flex-start",
    alignItems: "center",
    width: "100%"
  }, React__default.createElement("input", {
  ...
  }, "At least 1 uppercase letter")), React__default.createElement(StyledFlex, {
    justifyContent: "flex-start",
    alignItems: "center",
    width: "100%"
  }, React__default.createElement("input", {
  ...
  }, "At least 1 numeric character")), React__default.createElement(StyledFlex, {
    justifyContent: "flex-start",
    alignItems: "center",
    width: "100%"
  }, React__default.createElement("input", {
  ...
  }, "At least 1 special character")), React__default.createElement(StyledFlex, {
    justifyContent: "flex-start",
    alignItems: "center",
    width: "100%"
  }, React__default.createElement("input", {
...
var AuthorizerVerifyOtp = function AuthorizerVerifyOtp(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, successMessage && React__default.createElement(Message, {
    type: MessageType.Success,
    text: successMessage,
    onClose: onSuccessClose
  }), error && React__default.createElement(Message, {
  ...
  }, "Please enter the OTP sent to your email or phone number or authenticator"), React__default.createElement("br", null), React__default.createElement("form", {
    onSubmit: onSubmit,
  ...
  }, React__default.createElement("span", null, "* "), "OTP (One Time Password)"), React__default.createElement("input", {
    name: "otp",
  ...
  }), errorData.otp && React__default.createElement("div", {
    className: styles['form-input-error']
  }, errorData.otp), is_totp && React__default.createElement(Message, {
  ...
  })), React__default.createElement("br", null), React__default.createElement(StyledButton, {
    type: "submit",
    disabled: loading || !formData.otp || !!errorData.otp,
    appearance: ButtonAppearance.Primary
  }, loading ? "Processing ..." : "Submit")), setView && React__default.createElement(StyledFooter, null, sendingOtp ? React__default.createElement("div", {
    style: {
      marginBottom: '10px'
    }
  }, "Sending ...") : React__default.createElement(StyledLink, {
    onClick: resendOtp,
    marginBottom: "10px"
  }, "Resend OTP"), config.is_sign_up_enabled && React__default.createElement("div", null, "Don't have an account?", ' ', React__default.createElement(StyledLink, {
...
var AuthorizerSignup = function AuthorizerSignup(_ref) {
  ...
  var _useState3 = React.useState(_extends({}, initOtpData)),
  ...
  if (otpData.is_screen_visible) {
    return React__default.createElement(React__default.Fragment, null, successMessage && React__default.createElement(Message, {
      type: MessageType.Success,
      text: successMessage
    }), React__default.createElement(AuthorizerVerifyOtp, Object.assign({}, {
      setView: setView,
      onLogin: onSignup,
      email: otpData.email || "",
  ...
  return React__default.createElement(React__default.Fragment, null, error && React__default.createElement(Message, {
    type: MessageType.Error,
    text: error,
    onClose: onErrorClose
  }), successMessage && React__default.createElement(Message, {
    type: MessageType.Success,
    text: successMessage
  }), (config.is_basic_authentication_enabled || config.is_mobile_basic_authentication_enabled) && !config.is_magic_link_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement("form", {
    onSubmit: onSubmit,
  ...
  }, React__default.createElement("span", null, "* "), "First Name"), React__default.createElement("input", {
    name: "given_name",
  ...
  }), errorData.given_name && React__default.createElement("div", {
    className: styles['form-input-error']
  }, errorData.given_name)), React__default.createElement("div", {
    className: styles['styled-form-group']
  }, React__default.createElement("label", {
  ...
  }, React__default.createElement("span", null, "* "), "Last Name"), React__default.createElement("input", {
    name: "family_name",
  ...
  }), errorData.family_name && React__default.createElement("div", {
    className: styles['form-input-error']
  }, errorData.family_name)), React__default.createElement("div", {
    className: styles['styled-form-group']
  }, React__default.createElement("label", {
  ...
  }, React__default.createElement("span", null, "* "), getEmailPhoneLabels(config)), React__default.createElement("input", {
  ...
  }), errorData.email_or_phone_number && React__default.createElement("div", {
    className: styles['form-input-error']
  }, errorData.email_or_phone_number)), React__default.createElement("div", {
    className: styles['styled-form-group']
  }, React__default.createElement("label", {
  ...
  }, React__default.createElement("span", null, "* "), "Password"), React__default.createElement("input", {
    name: "password",
  ...
  }), errorData.password && React__default.createElement("div", {
    className: styles['form-input-error']
  }, errorData.password)), React__default.createElement("div", {
    className: styles['styled-form-group']
  }, React__default.createElement("label", {
  ...
  }, React__default.createElement("span", null, "* "), "Confirm Password"), React__default.createElement("input", {
  ...
  }), errorData.confirmPassword && React__default.createElement("div", {
    className: styles['form-input-error']
  }, errorData.confirmPassword)), config.is_strong_password_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(PasswordStrengthIndicator, {
    value: formData.password || '',
    setDisableButton: setDisableSignupButton
  }), React__default.createElement("br", null)), React__default.createElement("br", null), React__default.createElement(StyledButton, {
    type: "submit",
    ...
    appearance: ButtonAppearance.Primary
  }, loading ? "Processing ..." : "Sign Up")), setView && React__default.createElement(StyledFooter, null, React__default.createElement("div", null, "Already have an account?", ' ', React__default.createElement(StyledLink, {
    onClick: function onClick() {
...
var AuthorizerTOTPScanner = function AuthorizerTOTPScanner(_ref) {
  ...
  if (isOTPScreenVisisble) {
    return React__default.createElement(AuthorizerVerifyOtp, Object.assign({}, {
      setView: setView,
      onLogin: onLogin,
      email: email,
      phone_number: phone_number,
  ...
  }, "Scan the QR code or enter the secret key into your authenticator app."), React__default.createElement(StyledFlex, {
    justifyContent: "center"
  ...
  }, "If you are unable to scan the QR code, please enter the secret key manually."), React__default.createElement("p", {
    style: {
      margin: '10px 0px',
      fontWeight: 'bold'
    }
  }, authenticator_secret), React__default.createElement(StyledSeparator, null), React__default.createElement("p", {
    style: {
      margin: '10px 0px'
    }
  }, "If you lose access to your authenticator app, you can use the recovery codes below to regain access to your account. Please save these codes safely and do not share them with anyone."), React__default.createElement("ul", null, authenticator_recovery_codes.map(function (code, index) {
...
var AuthorizerBasicAuthLogin = function AuthorizerBasicAuthLogin(_ref) {
  ...
  var _useState2 = React.useState(false),
    loading = _useState2[0],
    setLoading = _useState2[1];
  var _useState3 = React.useState(_extends({}, initOtpData$1)),
    otpData = _useState3[0],
    setOtpData = _useState3[1];
  var _useState4 = React.useState(_extends({}, initTotpData)),
  ...
  if (totpData.is_screen_visible) {
    return React__default.createElement(AuthorizerTOTPScanner, Object.assign({}, {
      setView: setView,
      onLogin: onLogin,
  ...
  return React__default.createElement(React__default.Fragment, null, error && React__default.createElement(Message, {
    ...
    text: error,
    onClose: onErrorClose
  }), React__default.createElement(React__default.Fragment, null, React__default.createElement("form", {
    onSubmit: onSubmit,
    ...
    className: styles['form-input-error']
  }, errorData.password)), React__default.createElement("br", null), React__default.createElement(StyledButton, {
    type: "submit",
    disabled: !!errorData.email_or_phone_number || !!errorData.password || !formData.email_or_phone_number || !formData.password || loading,
    appearance: ButtonAppearance.Primary
  }, loading ? "Processing ..." : "Log In")), setView && React__default.createElement(StyledFooter, null, React__default.createElement(StyledLink, {
    onClick: function onClick() {
      return setView(Views.ForgotPassword);
    },
    marginBottom: "10px"
  }, "Forgot Password?"), config.is_sign_up_enabled && React__default.createElement("div", null, "Don't have an account?", ' ', React__default.createElement(StyledLink, {
    onClick: function onClick() {
      return setView(Views.Signup);
    }
  }, "Sign Up")))));
...
var AuthorizerMagicLinkLogin = function AuthorizerMagicLinkLogin(_ref) {
  ...
  }, React__default.createElement("span", null, "* "), "Email"), React__default.createElement("input", {
    name: "email",
  ...
  }), errorData.email && React__default.createElement("div", {
    className: styles['form-input-error']
  }, errorData.email)), React__default.createElement("br", null), React__default.createElement(StyledButton, {
    type: "submit",
...
var AuthorizerResetPassword = function AuthorizerResetPassword(_ref) {
  ...
  return React__default.createElement(StyledWrapper, null, error && React__default.createElement(Message, {
    type: MessageType.Error,
    text: error,
    onClose: onErrorClose
  }), React__default.createElement("form", {
  ...
  }, showOTPInput && React__default.createElement("div", {
    className: styles['styled-form-group']
  }, React__default.createElement("label", {
    className: styles['form-input-label'],
    htmlFor: "authorizer-verify-otp"
...
var AuthorizerForgotPassword = function AuthorizerForgotPassword(_ref) {
  ...
  var _useState3 = React.useState(""),
    successMessage = _useState3[0],
    setSuccessMessage = _useState3[1];
  var _useState4 = React.useState(_extends({}, initOtpData$2)),
  ...
  if (successMessage) {
    return React__default.createElement(React__default.Fragment, null, React__default.createElement(Message, {
      type: MessageType.Success,
      text: successMessage
    }), otpData.is_screen_visible && React__default.createElement(AuthorizerResetPassword, {
      showOTPInput: true,
  ...
  return React__default.createElement(React__default.Fragment, null, error && React__default.createElement(Message, {
  ...
  }, "Please enter your ", getEmailPhoneLabels(config), ".", React__default.createElement("br", null), " We will send you an email / otp to reset your password."), React__default.createElement("br", null), React__default.createElement("form", {
    onSubmit: onSubmit,
    ...
    className: styles['form-input-error']
  }, errorData.email_or_phone_number)), React__default.createElement("br", null), React__default.createElement(StyledButton, {
    type: "submit",
    disabled: loading || !!errorData.email_or_phone_number || !formData.email_or_phone_number,
    appearance: ButtonAppearance.Primary
  }, loading ? "Processing ..." : "Request Change")), setView && React__default.createElement(StyledFooter, null, React__default.createElement("div", null, "Remember your password?", ' ', React__default.createElement(StyledLink, {
    onClick: function onClick() {
      return setView(Views.Login);
    }
  }, "Log In"))));
...
var AuthorizerSocialLogin = function AuthorizerSocialLogin(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, config.is_apple_login_enabled && React__default.createElement("div", {
    id: "appleid-signin"
  }, React__default.createElement(StyledButton, {
  ...
  }, React__default.createElement(Apple, null), "Continue with Apple"), React__default.createElement("br", null)), config.is_google_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledButton, {
    appearance: ButtonAppearance.Default,
    onClick: function onClick() {
      window.location.href = config.authorizerURL + "/oauth_login/google?" + queryParams;
    }
  }, React__default.createElement(Google, null), "Continue with Google"), React__default.createElement("br", null)), config.is_github_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledButton, {
    appearance: ButtonAppearance.Default,
    onClick: function onClick() {
      window.location.href = config.authorizerURL + "/oauth_login/github?" + queryParams;
    }
  }, React__default.createElement(Github, null), "Continue with Github"), React__default.createElement("br", null)), config.is_facebook_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledButton, {
    appearance: ButtonAppearance.Default,
    onClick: function onClick() {
      window.location.href = config.authorizerURL + "/oauth_login/facebook?" + queryParams;
    }
  }, React__default.createElement(Facebook, null), "Continue with Facebook"), React__default.createElement("br", null)), config.is_linkedin_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledButton, {
    appearance: ButtonAppearance.Default,
    onClick: function onClick() {
      window.location.href = config.authorizerURL + "/oauth_login/linkedin?" + queryParams;
    }
  }, React__default.createElement(LinkedIn, null), "Continue with LinkedIn"), React__default.createElement("br", null)), config.is_twitter_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledButton, {
    appearance: ButtonAppearance.Default,
    onClick: function onClick() {
      window.location.href = config.authorizerURL + "/oauth_login/twitter?" + queryParams;
    }
  }, React__default.createElement(Twitter, null), "Continue with Twitter"), React__default.createElement("br", null)), config.is_microsoft_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledButton, {
    appearance: ButtonAppearance.Default,
    onClick: function onClick() {
      window.location.href = config.authorizerURL + "/oauth_login/microsoft?" + queryParams;
    }
  }, React__default.createElement(Microsoft, null), "Continue with Microsoft"), React__default.createElement("br", null)), config.is_twitch_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledButton, {
    appearance: ButtonAppearance.Default,
    onClick: function onClick() {
      window.location.href = config.authorizerURL + "/oauth_login/twitch?" + queryParams;
    }
  }, React__default.createElement(Twitch, null), "Continue with Twitch"), React__default.createElement("br", null)), config.is_roblox_login_enabled && React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledButton, {
    appearance: ButtonAppearance.Default,
    onClick: function onClick() {
      window.location.href = config.authorizerURL + "/oauth_login/roblox?" + queryParams;
    }
  }, React__default.createElement(Roblox, null), "Continue with Roblox"), React__default.createElement("br", null)), hasSocialLogin && (config.is_basic_authentication_enabled || config.is_mobile_basic_authentication_enabled || config.is_magic_link_login_enabled) && React__default.createElement(StyledSeparator, null, "OR"));
};
...
var AuthorizerRoot = function AuthorizerRoot(_ref) {
  ...
  var onLogin = _ref.onLogin,
    ...
    onPasswordReset = _ref.onPasswordReset,
    roles = _ref.roles;
  var _useState = React.useState(Views.Login),
    view = _useState[0],
    setView = _useState[1];
  var _useAuthorizer = useAuthorizer(),
    config = _useAuthorizer.config;
  ...
  return React__default.createElement(StyledWrapper, null, React__default.createElement(AuthorizerSocialLogin, {
    urlProps: urlProps,
    roles: roles
  }), view === Views.Login && (config.is_basic_authentication_enabled || config.is_mobile_basic_authentication_enabled) && !config.is_magic_link_login_enabled && React__default.createElement(AuthorizerBasicAuthLogin, {
    setView: setView,
    onLogin: onLogin,
    urlProps: urlProps,
    roles: roles
  }), view === Views.Signup && (config.is_basic_authentication_enabled || config.is_mobile_basic_authentication_enabled) && !config.is_magic_link_login_enabled && config.is_sign_up_enabled && React__default.createElement(AuthorizerSignup, {
    setView: setView,
    onSignup: onSignup,
    urlProps: urlProps,
    roles: roles
  }), view === Views.Login && config.is_magic_link_login_enabled && React__default.createElement(AuthorizerMagicLinkLogin, {
    onMagicLinkLogin: onMagicLinkLogin,
    urlProps: urlProps,
    roles: roles
  }), view === Views.ForgotPassword && React__default.createElement(AuthorizerForgotPassword, {
    setView: setView,
...
exports.Authorizer = AuthorizerRoot;
exports.AuthorizerBasicAuthLogin = AuthorizerBasicAuthLogin;
exports.AuthorizerForgotPassword = AuthorizerForgotPassword;
exports.AuthorizerMagicLinkLogin = AuthorizerMagicLinkLogin;
exports.AuthorizerProvider = AuthorizerProvider;
exports.AuthorizerResetPassword = AuthorizerResetPassword;
exports.AuthorizerSignup = AuthorizerSignup;
exports.AuthorizerSocialLogin = AuthorizerSocialLogin;
exports.AuthorizerTOTPScanner = AuthorizerTOTPScanner;
exports.AuthorizerVerifyOtp = AuthorizerVerifyOtp;
exports.useAuthorizer = useAuthorizer;
//# sourceMappingURL=authorizer-react.cjs.development.js.map
