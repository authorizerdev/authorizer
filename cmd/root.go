...
func init() {
	...
	f.BoolVar(&rootArgs.config.OAuth21Strict, "oauth21-strict", false, "Enforce OAuth 2.1 restrictions: reject the implicit/hybrid-with-token response types (token, id_token token) and PKCE plain (require S256). Breaking; opt-in")
