...
| Area | v1 | v2 |
|------|----|----|
| **Configuration** | Environment persisted in cache/DB; configurable via dashboard, `.env`, or OS env | **All configuration via CLI root arguments only**; no env in cache or DB |
